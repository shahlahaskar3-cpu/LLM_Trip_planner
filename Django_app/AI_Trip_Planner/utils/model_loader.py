...
class ModelLoader(BaseModel):
    ...
    def load_llm(self):
        ...
        if self.model_provider == "groq":
            ...
            # Lower temperature -> more reliable, consistently-formatted
            # tool calls. Groq/Llama models are prone to malformed
            # "tool_use_failed" errors at higher temperatures.
